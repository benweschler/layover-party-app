                    ...
                    Expanded(
                      child: Container(
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: AppColors.of(context).secondary.withOpacity(0.07),
                            //TODO: color: AppColors.of(context).smallSurface,
                            width: 2,
                          ),
                        ),
                        child: Material(
...
class _ThemeWindow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //TODO: remove
    final Color contrast = (appColors.isDark ? Colors.white : Colors.black);

    final textColor = contrast.withOpacity(0.65);
